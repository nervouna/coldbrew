...
extension NSPasteboard.PasteboardType: Defaults.Serializable {
  ...
  // Marks that copy was made from this application, independently of upstream Maccy.
  static let fromMaccy = NSPasteboard.PasteboardType(rawValue: Bundle.main.bundleIdentifier ?? "io.damao.coldbrew")
