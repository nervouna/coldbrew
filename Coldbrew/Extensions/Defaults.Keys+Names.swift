...
extension Defaults.Keys {
  ...
  static let testingSuiteName = "\(Bundle.main.bundleIdentifier ?? "io.damao.coldbrew").uitests"
  ...
  static let menuIcon = Key<MenuIcon>("menuIcon", default: .coldbrew, suite: preferencesSuite)
